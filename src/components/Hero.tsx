  ...
  return (
    <section ref={containerRef} id="home" className="relative min-h-[100svh] w-full flex flex-col items-center justify-center overflow-hidden bg-aviation-navy pt-20">
      ...
      <div className="relative z-10 container mx-auto px-6 flex flex-col items-center justify-center text-center">
        ...
        >
          <h1 className="font-heading text-4xl md:text-6xl lg:text-[6rem] font-bold leading-[0.9] tracking-tighter text-primary-dark">
            Master the skies. <br />
        ...
        >
          {metrics.map((metric, i) => (
            <motion.div
              ...
              className="bg-white/70 backdrop-blur-2xl p-4 md:p-6 rounded-[1.5rem] border border-white/60 shadow-[0_10px_40px_rgba(0,0,0,0.03)] flex flex-col items-center justify-center transition-all duration-500"
            >
              <div className="text-2xl md:text-3xl font-heading font-bold text-primary-dark mb-1">{metric.value}</div>
              <div className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-royal-purple/60 text-center">{metric.label}</div>
            </motion.div>
          ))}
        </motion.div>
